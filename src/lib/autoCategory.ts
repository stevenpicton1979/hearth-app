const RULES: Record<string, string[]> = {
  'Transport': ['UBER', 'AMPOL', '7-ELEVEN', 'BP', 'SHELL', 'CALTEX', 'LINKT', 'TRANSLINK', 'REPCO'],
  'Eating Out': ['MCDONALD', 'KFC', 'HUNGRY JACKS', 'GUZMAN', 'DOMINOS', 'SUBWAY', 'PIZZA', 'RESTAURANT', 'CAFE', 'COFFEE', 'BAKERY', 'GRILL', 'TAKEAWAY', 'BAR', 'PUB', 'BISTRO', 'BUFFET', 'RSL', 'LEAGUES CLUB'],
  ...
  'Medical': ['CHEMIST', 'PHARMACY', 'PRICELINE', 'DOCTOR', 'DENTAL', 'PHYSIO', 'PATHOLOGY', 'HOSPITAL', 'CLINIC', 'PSYCHOLOGY'],
  ...
  'Shopping': ['AMAZON AU', 'OFFICEWORKS', 'JB HI FI', 'EBAY', 'MYER', 'DAVID JONES', 'REBEL SPORT'],
