...
## [ ] 2. Fix .gitattributes (CRLF warnings)
...
## [ ] 3. Add /mappings to sidebar navigation
...
## [ ] 4. Subscriptions UI — Confirm and Dismiss per row
...
## [ ] 7. Training card — show example transaction descriptions
